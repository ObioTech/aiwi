...
AIWI is a local-first Project Brain for AI agents. 

It helps agents retrieve project documents, source code context, approved memories, operational evidence, and workflow guidance before making recommendations or changes. Rather than letting an AI agent guess or act blindly, AIWI establishes a structured evidence layer.

## High-Level Architecture

AIWI organizes project knowledge into a few key conceptual layers:
...
By splitting the infrastructure (MCP tools) from the intelligence (Agent Profiles), AIWI keeps the system predictable, local, and fully under developer control.
