# ObiBrain — Local-first Project Brain for AI Agents
**A local-first Project Brain for AI agents**

ObiBrain helps coding agents understand project knowledge, source code, decisions, memory, and operational evidence before they act.

---

## What is ObiBrain?
ObiBrain is an experimental local-first infrastructure layer that helps AI agents work with project knowledge. 
...
ObiBrain is designed to keep project intelligence close to the developer workspace, running locally and keeping your data under your control.
...
## Current Status
ObiBrain is currently an early private project. The core package is private, while this public site shares the thinking, architecture notes, and lessons learned from building it.

## Start Reading
- [Why I'm Building ObiBrain](_posts/2026-06-15-why-im-building-aiwi.md) (Read the blog post)
- [About ObiBrain](about.md) (Learn about the architecture)
