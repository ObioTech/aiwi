...
Welcome to the public writing space for ObiBrain. Here we share our engineering thoughts, architectural notes, and lessons learned from building a local-first Project Brain.

## Published Notes

*   **June 15, 2026** — [Why I'm Building ObiBrain](posts/why-im-building-aiwi/)
...
- **Project Brain, Not Workflow Suite**: Why separating context from task tracking keeps intelligence clean.
- **Why Local-First Matters**: How code privacy and workspace-native speed shape AI developer tooling.
...
- **Why ObiBrain Does Not Embed Every Ticket**: Filtering operational noise from long-term project knowledge.
